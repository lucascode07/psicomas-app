    ...
    return (
        <div className={styles.m_card_professional}>
            <Image
                ...
                width={126}
                height={126} />
            <p className={styles.professional_name}>Ana Villa González</p>
            <small>Cedula 93279</small>
            <p className={styles.professional_specialties}>
                Psicología, Sexualidad Conflictos personales, Terapia de pareja
            </p>
            <Link href={'#'} className={styles.professional_link}>
